...
class Sedes(ClaseModelo):
    ...
    foto1 = models.FileField("Foto Sede (476x570)", upload_to="fotos/", blank=False, null=False, default="")
    foto2 = models.FileField("Foto Sede (476x570)", upload_to="fotos/", blank=False, null=False, default="")
    foto3 = models.FileField("Foto Sede (476x570)", upload_to="fotos/", blank=False, null=False, default="")
