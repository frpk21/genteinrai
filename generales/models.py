...
class Sedes(ClaseModelo):
    ...
    foto1 = models.FileField("Foto Sede (800x600)", upload_to="fotos/", blank=True, null=True, default="")
    foto2 = models.FileField("Foto Sede (800x600)", upload_to="fotos/", blank=True, null=True, default="")
    foto3 = models.FileField("Foto Sede (800x600)", upload_to="fotos/", blank=True, null=True, default="")
